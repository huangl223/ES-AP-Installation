note
	...
	date: "$Date: 2020-05-19 14:46:56 +0000 (Tue, 19 May 2020) $"
	revision: "$Revision: 104271 $"
	...
	execute
		...
		do
			...
			create log_file.make_with_name (l_log_filename)
				...
				-- Create branch log file
			create branch_log_file.make_create_read_write (l_log_filename.substring (1, l_log_filename.count - 19).to_string_8 + "\branch_log.txt")
...
--			has_exception: An exception happened before
		...
		do
			...
			-- log branches   
			if l_tag.has_substring ("Branch ") then
				branch_log_file.put_string (l_tag + "%N")
			end
		end
...
feature {NONE}
	...
	branch_log_file: PLAIN_TEXT_FILE
		-- Text file to store branch information
