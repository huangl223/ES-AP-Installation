note
	...
	date: "$Date: 2020-09-15 01:45:08 +0300 (Вт, 15 сен 2020) $"
	revision: "$Revision: 104658 $"
...
feature {NONE} -- Access
	...
	context: ARRAY [TUPLE [type: TYPE [ANY]; attributes: TUPLE; is_inv: BOOLEAN]]
			...
			-- is_inv:        True if object must satisfy its invariants. False if object was part of call
